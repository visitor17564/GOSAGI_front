...
export async function getMostView() {
  try {
    ...
    const response = await axios.get(`https://https.visitor.run/goods/views`, { withCredentials: true });
...
export async function getMostWish() {
  try {
    ...
    const response = await axios.get(`https://https.visitor.run/goods/wishes`, { withCredentials: true });
    const products = response.data.data;
...
export async function getPopular() {
  try {
    ...
    const response = await axios.get(`https://https.visitor.run/goods/bestProducts`, { withCredentials: true });
    const products = response.data.data;
