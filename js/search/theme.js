...
export async function getMostView() {
  try {
    ...
    const response = await axios.get(`http://52.79.88.29:3000/goods/views`, { withCredentials: true });
...
export async function getMostWish() {
  try {
    ...
    const response = await axios.get(`http://52.79.88.29:3000/goods/wishes`, { withCredentials: true });
    const products = response.data.data;
...
export async function getPopular() {
  try {
    ...
    const response = await axios.get(`http://52.79.88.29:3000/goods/bestProducts`, { withCredentials: true });
    const products = response.data.data;
