    ...
    if (addresses.length >= 1) {
      ...
      addresses.forEach((address) => {
        ...
        <td class="text-center px-6 py-3 gap-2 flex flex-col justify-center items-center">
          <button id="chooseAddress:${address.id}" class="h-5 w-10 hover:bg-gray-400 hover:text-white border border-gray-400 text-gray-400 text-center bg-white items-center rounded-lg max-md:max-w-full max-md:px-5 font-['Inter']">선택</button>
        </td>
      </tr>`;
